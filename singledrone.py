...
Img = pygame.image.load('tello2.png')  # Replace with your image file path
Img = scaleImgDown( Img, 0.03) # Scale down to 3%
...
def localize():
    ...
    current_pos = list(start_pos2)
    previous_pos=  current_pos.copy()
    num_steps = int(timeDur / updateTime)
    angle_num_steps = int(rotationDur / angleUpdateTime)
    ...
    dx2 = (end_pos2[0] - start_pos2[0]) /  num_steps
    dy2 = (end_pos2[1] - start_pos2[1]) /  num_steps
    ...
    drawPoints(screen,  points,  Img, yaw2)
