        ...
        if self.idx % 5 == 0:
            ...
            for out in outs:
                for detection in out:
                    ...
                    if confidence > 0.5 and class_id == 0:  # Only detect "person"
            ...
            if len(confidences) > 0:
                ...
                if center_x > width / 2 + 30:
                    self.turn = int(max(10, min(30, 20 * (abs(center_x - width)))))
                elif center_x < width / 2 - 30:
                    self.turn = -1 * int(max(10, min(30, 20 * (abs(center_x - width)))))
                else:
                    self.turn = 1
            else:
