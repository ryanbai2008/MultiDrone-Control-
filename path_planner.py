...
class PathPlan:
    ...
    def move_towards_goal(self, X_curr, Y_curr, angle_curr, terminate):
        ...
        X_movement = math.sin(angle_diff_smaller) * self.original_magnitude_diff * 0.1
        Y_movement = math.cos(angle_diff_smaller) * self.original_magnitude_diff * 0.1 #change for smoother or less smooth path
